...
function Vendor(this: any, cfg: any) {
  this.name = '';
  this.items = [];
  this.stock = [];
  ...
  this.extra = function () { }
  this.onRestock = function (this: any) { this.restocked = true }
  this.onDayPass = function (this: any) { if (--this.data.time === 0) { restock(this); this.data.time = this.timeorig; this.onRestock(); this.extra() } }
