...
furniture.cat.use = function (this: any) {
...
furniture.frplc.use = function (this: any) {
...
furniture.bed1.onGive = function (this: any) {
...
furniture.bed2.onGive = function (this: any) {
  if (!home.bed || home.bed.sq < this.sq) home.bed = this;
}
furniture.bed2.onRemove = function (this: any) {
...
furniture.tbwr1.activate = function (this: any) { if (home.tbw.id === this.id) skl.glt.p += .05 };
furniture.tbwr1.deactivate = function (this: any) { if (home.tbw.id === this.id) skl.glt.p -= .05 };
furniture.tbwr1.onGive = function (this: any) {
  if (!home.tbw || home.tbw.sq < this.sq) home.tbw = this;
}
furniture.tbwr1.onRemove = function (this: any) {
...
furniture.tbwr2.onGive = function (this: any) {
...
furniture.tbwr3.onGive = function (this: any) {
...
furniture.wvbkt.onRemove = function (this: any) {
...
furniture.bblkt.activate = function (this: any) { if (home.blkt.id === this.id) skl.sleep.p += .5 };
furniture.bblkt.deactivate = function (this: any) { if (home.blkt.id === this.id) skl.sleep.p -= .5 };
furniture.bblkt.onGive = function (this: any) {
  if (!home.blkt || home.blkt.sq < this.sq) home.blkt = this;
}
furniture.bblkt.onRemove = function (this: any) {
...
furniture.spillw.activate = function (this: any) { if (home.pilw.id === this.id) skl.sleep.p += .3 };
furniture.spillw.deactivate = function (this: any) { if (home.pilw.id === this.id) skl.sleep.p -= .3 };
furniture.spillw.onGive = function (this: any) {
  if (!home.pilw || home.pilw.sq < this.sq) home.pilw = this;
}
furniture.spillw.onRemove = function (this: any) {
...
furniture.cyrn.activate = function (this: any) { skl.pet.p += .15; you.mods.petxp += .25 };
furniture.cyrn.deactivate = function (this: any) { skl.pet.p -= .15; you.mods.petxp -= .25 };
furniture.cyrn.onRemove = function (this: any) {
...
furniture.fwdpile.desc = function (this: any) {
...
furniture.fwdpile.onRemove = function (this: any) {
  giveItem(item.fwdpile, 1, true);
}
furniture.fwdpile.onSelect = function (this: any) {
  let f = item.fwd1;
...
furniture.bookgen.desc = function (this: any) { return 'Book which you\'ve already read. It doesn\'t contain any new useful information' + dom.dseparator + '<span style="color:deeppink">Literacy EXP gain +1%</span><br><br><small style="color:deeppink">Current:<span style="color:orange"> +' + Math.round(furniture.bookgen.data.p * 100) + '%</span></small>' }
furniture.bookgen.activate = function (this: any) { skl.rdg.p += this.data.p };
furniture.bookgen.deactivate = function (this: any) { skl.rdg.p -= this.data.p };
furniture.bookgen.onGive = function (this: any) { ; if (inSector(sector.home) && this.active) skl.rdg.p += .01; this.data.p += .01; }
furniture.bookgen.onRemove = function (this: any) {
...
quest.test.init = function (this: any) { this.data.itm = item.rwmt1; this.data.started = true; };
quest.test.tracker = function (this: any) { if (this.data.itm.amount >= 10) this.data.pending = true; else { this.data.pending = false; this.data.toup = true }; };
quest.test.fpending = function (this: any) { msg('10 item found'); this.data.toup = false };
quest.test.rwd = function (this: any) { this.data.done = true; this.data.pending = false; msg('done'); };
...
quest.fwd1.rwd = function (this: any) { you.karma++; giveWealth(100); giveItem(sld.bkl); smove(chss.frstn1b1, false); giveExp(15000, true, true, true) }
quest.fwd1.goals = function (this: any) {
  let c;
...
quest.fwd1.goalsf = function (this: any) {
...
quest.hnt1.rwd = function (this: any) { you.karma++; giveWealth(130); giveItem(item.jrk1, 10); giveExp(12000, true, true, true) }
quest.hnt1.goals = function (this: any) {
  let c;
...
quest.hnt1.goalsf = function (this: any) {
...
quest.grds1.rwd = function (this: any) { this.data.t++; giveWealth(65); giveExp(3000, true, true, true); global.stat.jcom++ };
quest.grds1.goals = function (this: any) {
  return ['Guard the gate until 8PM (<span style="color:yellow">in progress</span>)']
}
quest.grds1.goalsf = function (this: any) {
...
quest.lmfstkil1.init = function (this: any) { this.callback() }
quest.lmfstkil1.callback = function (this: any) {
...
quest.lmfstkil1.rwd = function (this: any) { this.data.t++; giveWealth(300); giveItem(wpn.gsprw); giveItem(eqp.nkgd); giveExp(18000, true, true, true); detachCallback(callback.onDeath, 1005); }
quest.lmfstkil1.goals = function (this: any) {
  let c;
...
quest.lmfstkil1.goalsf = function (this: any) {
