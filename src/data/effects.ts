...
effect.psn.onGive = function (x: any, y: any) {
...
effect.psn.use = function (y: any, z: any) {
  this.duration--;
  var dmg = y || 1;
  this.power = y;
...
effect.vnm.onGive = function (x: any, y: any) {
...
effect.vnm.use = function (y: any, z: any) {
  this.duration--;
  var dmg = y;
  this.power = y;
  if (this.target.id === you.id) {
...
effect.fpn.use = function (y: any, z: any) {
...
effect.bled.onGive = function (x: any, y: any) {
...
effect.bled.use = function (y: any, z: any) {
  this.duration--;
  this.power = y;
  let dmg = this.power;
...
effect.tarnish.use = function (y: any, z: any) {
}
...
effect.prostasia.use = function (y: any, z: any) {
}
...
effect.fei1.onGive = function (x: any, y: any) {
...
effect.fei1.use = function (y: any) {
  this.duration--;
