...
area.trnf = new Area({
  ...
  pop: [{ crt: creature.sdummy, lvlmin: 1, lvlmax: 12, c: .3 }, { crt: creature.tdummy, lvlmin: 7, lvlmax: 13, c: .3 }, { crt: creature.wdummy, lvlmin: 8, lvlmax: 10, c: .3 }],
  size: -1,
  protected: true,
  drop: [{ item: acc.gpin, c: .00012, cond: () => { return ttl.tqtm.tget } }]
});
z_bake(area.trnf);
...
// @ts-ignore: constructor function
area.tst = new Area({
  id: 108, name: 'Test', pop: [{ crt: creature.skl, lvlmin: 1, lvlmax: 1, c: 1 }], size: -1,
  onEnd: function () { }
});
z_bake(area.tst);
...
area.frstn1a2 = new Area({
  id: 109, name: 'Western forest hunting area', pop: [{ crt: creature.rbt1, lvlmin: 1, lvlmax: 5, c: .20 }, { crt: creature.slm1, lvlmin: 1, lvlmax: 6, c: .40 }, { crt: creature.slm2, lvlmin: 1, lvlmax: 6, c: .40 }], size: 60,
  onEnd: function (this: any) {
  ...
  drop: [{ item: item.hrb1, c: .02 }, { item: item.wdc, c: .05 }]
});
z_bake(area.frstn1a2);

// @ts-ignore: constructor function
area.hmbsmnt = new Area({
  id: 110, name: 'Your basement', pop: [{ crt: creature.bat, lvlmin: 10, lvlmax: 17, c: .50 }, { crt: creature.spd1, lvlmin: 10, lvlmax: 17, c: .50 }], size: 10,
  onEnd: function () {
    smove(chss.bsmnthm1, false);
  },
  drop: [{ item: item.cp, c: .05 }, { item: item.lcn, c: .003 }, { item: item.cn, c: .02 }, { item: item.cd, c: .01 }, { item: item.wdc, c: .08 }, { item: acc.wpeny, c: .001 }]
});
z_bake(area.hmbsmnt);
...
area.frstn2a2 = new Area({
  id: 112, name: 'Western forest hunting area', pop: [{ crt: creature.rbt1, lvlmin: 1, lvlmax: 7, c: .25 }, { crt: creature.slm1, lvlmin: 1, lvlmax: 8, c: .20 }, { crt: creature.slm2, lvlmin: 1, lvlmax: 8, c: .20 }, { crt: creature.slm3, lvlmin: 1, lvlmax: 5, c: .25 }], size: 50,
  onEnd: function (this: any) {
    roll(item.acrn, .2, 1, 3);
    roll(item.cp, .2, 1, 8);
    roll(wpn.knf2, .03);
...
area.frstn1a3 = new Area({
  id: 115, name: 'Western forest hunting area', pop: [{ crt: creature.rbt1, lvlmin: 3, lvlmax: 8, c: .35 }, { crt: creature.slm1, lvlmin: 3, lvlmax: 9, c: .15 }, { crt: creature.slm2, lvlmin: 3, lvlmax: 9, c: .15 }, { crt: creature.slm3, lvlmin: 2, lvlmax: 5, c: .2 }], size: -1,
  protected: true,
  drop: [{ item: item.hrb1, c: .009 }, { item: item.wdc, c: .025 }, { item: item.acrn, c: .001 }, { item: item.mshr, c: .002 }, { item: item.cp, c: .002 }, { item: wpn.knf2, c: .00009 }, { item: wpn.ktn1, c: .00006 }, { item: wpn.stk1, c: .0007 }, { item: item.sbone, c: .0009 }, { item: item.wbrs, c: .003 }, { item: item.spb, c: .0004 }, { item: item.pcn, c: .001 }, { item: item.fwd1, c: .0009 }]
});
z_bake(area.frstn1a3);

// @ts-ignore: constructor function
area.frstn1a4 = new Area({
  id: 116, name: 'Western forest hidden area', pop: [{ crt: creature.slm4, lvlmin: 9, lvlmax: 11, c: 1 }], size: 25,
  protected: true,
  drop: [{ item: item.cp, c: .006 }, { item: wpn.stk1, c: .0009 }, { item: item.sbone, c: .0005 }],
  onEnd: function () {
    chss.frstn1a4.sl()
  }
});
...
area.frstn9a1 = new Area({
  id: 118, name: 'Southern forest hunting area', pop: [{ crt: creature.wolf1, lvlmin: 7, lvlmax: 8, c: .25 }, { crt: creature.slm5, lvlmin: 10, lvlmax: 11, c: .75 }], size: 48,
  onEnd: function (this: any) {
...
sector.home = new Sector({
  ...
  onScout: function (this: any) { scoutGeneric(this) },
