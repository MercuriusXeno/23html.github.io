...
// @ts-ignore: constructor function
skl.alch = new Skill({
  id: 120, type: 5, name: 'Alchemy', desc: 'Knowledge of medicine and alchemical transmutation', mlstn: [{ lv: 1, f: () => { you.inta += 1; giveRcp(rcp.hptn1) }, g: false, p: "INT +1" }],
  use: function (this: any, x: any, y: any) { giveSkExp(this, x || 1); return this.lvl || 1 }
});
...
skl.abw = new Skill({
  ...
  use: function (this: any, x: any, y: any) { return this.lvl },
  onLevel: function (this: any) { you.cmaff[3] += Math.ceil(this.lvl / 3 + 1) },
  onGive: function (this: any, x: any) { if (!you.ki['w']) you.ki['w'] = x; else you.ki['w'] += x }
});
...
skl.abf = new Skill({
  ...
  use: function (this: any, x: any, y: any) { return this.lvl },
  onLevel: function (this: any) { you.cmaff[4] += Math.ceil(this.lvl / 3 + 1) },
  onGive: function (this: any, x: any) { if (!you.ki['f']) you.ki['f'] = x; else you.ki['f'] += x }
});
...
skl.aba = new Skill({
  ...
  use: function (this: any, x: any, y: any) { return this.lvl },
  onLevel: function (this: any) { you.cmaff[1] += Math.ceil(this.lvl / 3 + 1) },
  onGive: function (this: any, x: any) { if (!you.ki['a']) you.ki['a'] = x; else you.ki['a'] += x }
});
...
skl.abe = new Skill({
  ...
  use: function (this: any, x: any, y: any) { return this.lvl },
  onLevel: function (this: any) { you.cmaff[2] += Math.ceil(this.lvl / 3 + 1) },
  onGive: function (this: any, x: any) { if (!you.ki['e']) you.ki['e'] = x; else you.ki['e'] += x }
});
...
skl.abl = new Skill({
  ...
  use: function (this: any, x: any, y: any) { return this.lvl },
  onLevel: function (this: any) { you.cmaff[5] += Math.ceil(this.lvl / 3 + 1) },
  onGive: function (this: any, x: any) { if (!you.ki['l']) you.ki['l'] = x; else you.ki['l'] += x }
});
...
skl.abd = new Skill({
  ...
  use: function (this: any, x: any, y: any) { return this.lvl },
  onLevel: function (this: any) { you.cmaff[6] += Math.ceil(this.lvl / 3 + 1) },
  onGive: function (this: any, x: any) { if (!you.ki['d']) you.ki['d'] = x; else you.ki['d'] += x }
});
...
skl.tghs = new Skill({
  ...
  use: function (this: any, x: any, y: any) { return this.lvl },
  onLevel: function (this: any) { you.cmaff[0] += Math.ceil(this.lvl / 3 + 1) }
});
