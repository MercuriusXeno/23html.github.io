...
function Skill(this: any, cfg?: any) {
  ...
  ///(i*.12)
  this.onLevel = function (this: any) { };
  this.onGive = function (this: any, x: any) { };
...
skl.fgt.use = function (this: any, x: any, y: any) { return you.str * (this.lvl * .02) }
...
skl.unc.use = function (this: any, x: any, y: any) { you.str += you.str / 100 * (this.lvl * 6); }
// @ts-ignore: constructor function
skl.srdc = new Skill({
...
skl.srdc.use = function (this: any, x: any, y: any) { you.str += you.str / 100 * (this.lvl * 5); }
...
skl.knfc.use = function (this: any, x: any, y: any) { you.str += you.str / 100 * (this.lvl * 5); }
...
skl.axc.use = function (this: any, x: any, y: any) { you.str += you.str / 100 * (this.lvl * 5); }
...
skl.plrmc.use = function (this: any, x: any, y: any) { you.str += you.str / 100 * (this.lvl * 5); }
...
skl.hmrc.use = function (this: any, x: any, y: any) { you.str += you.str / 100 * (this.lvl * 5); }

// @ts-ignore: constructor function
skl.stfc = new Skill({ id: 108, type: 1, name: 'Staff M', bname: 'Staff Mastery', desc: 'Ability to fight using staves and wands' });
skl.stfc.use = function (this: any, x: any, y: any) { you.int += you.int / 100 * (this.lvl * 5); }
...
skl.shdc.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1); you.str += you.str / 100 * (this.lvl * 5); you.int += you.int / 100 * (this.lvl * 3); }
...
skl.sleep.use = function (this: any, x: any, y: any) { giveSkExp(this, x.sq || 1); return 5 * this.lvl * x.sq }
...
skl.seye.use = function (this: any, x: any, y: any) { return this.lvl * 0.003 }
...
skl.pet.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1); }
...
skl.walk.use = function (this: any, x: any, y: any) { giveSkExp(this, .5); }
...
skl.dice.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1); }
...
skl.glt.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1); return this.lvl || 1 }
...
skl.rdg.use = function (this: any, x: any, y: any) { return this.lvl }
...
skl.cook.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1); return this.lvl || 1 }

// @ts-ignore: constructor function
skl.mdt = new Skill({ id: 118, type: 4, name: 'Meditation', desc: 'The rest of Mind' });
skl.mdt.use = function (this: any, x: any, y: any) { return this.lvl }
...
skl.crft.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1); return this.lvl || 1 }
...
skl.alch.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1); return this.lvl || 1 }
...
skl.thr.use = function (this: any, x: any, y: any) { return { a: this.lvl / 10, b: this.lvl * 5 } }

// @ts-ignore: constructor function
skl.bwc = new Skill({ id: 122, type: 1, name: 'Ranged M', bname: 'Ranged Mastery', desc: 'Ability to utilize bows and crossbows in combat' });
skl.bwc.use = function (this: any, x: any, y: any) { you.str += you.str / 100 * (this.lvl * 5); }
...
skl.ntst.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1) }

// @ts-ignore: constructor function
skl.evas = new Skill({ id: 124, type: 3, name: 'Evasion', desc: 'Ability to dodge attacks' });
skl.evas.use = function (this: any, x: any, y: any) { giveSkExp(this, x || 1) }

// @ts-ignore: constructor function
skl.gred = new Skill({ id: 125, type: 4, name: 'Greed', desc: 'The power of possessions' });
skl.gred.use = function (this: any, x: any, y: any) { return true }
...
skl.dngs.use = function (this: any, x: any, y: any) { return this.lvl }
...
skl.painr.use = function (this: any, x: any, y: any) { return this.lvl * .004 }
...
skl.poisr.use = function (this: any, x: any, y: any) { return this.lvl * .01 }
...
skl.fdpnr.use = function (this: any, x: any, y: any) { return this.lvl * .05 }
...
skl.war.use = function (this: any, x: any, y: any) { return this.lvl * .005 }

// @ts-ignore: constructor function
skl.stel = new Skill({ id: 131, type: 3, name: 'Stealing', desc: 'Ability to pilfer' });
skl.stel.use = function (this: any, x: any, y: any) { return this.lvl * .05 }
...
skl.dth.use = function (this: any, x: any, y: any) { return this.lvl * .1 }

// @ts-ignore: constructor function
skl.rtr = new Skill({ id: 133, type: 3, name: 'Elusion', desc: 'Ability to escape danger' });
skl.rtr.use = function (this: any, x: any, y: any) { return this.lvl }
...
skl.fmn.use = function (this: any, x: any, y: any) { return this.lvl * .01 }
...
skl.abw.use = function (this: any, x: any, y: any) { return this.lvl }
skl.abw.onLevel = function (this: any) { you.cmaff[3] += Math.ceil(this.lvl / 3 + 1) }
skl.abw.onGive = function (this: any, x: any) { if (!you.ki['w']) you.ki['w'] = x; else you.ki['w'] += x }
...
skl.abf.use = function (this: any, x: any, y: any) { return this.lvl }
skl.abf.onLevel = function (this: any) { you.cmaff[4] += Math.ceil(this.lvl / 3 + 1) }
skl.abf.onGive = function (this: any, x: any) { if (!you.ki['f']) you.ki['f'] = x; else you.ki['f'] += x }
...
skl.aba.use = function (this: any, x: any, y: any) { return this.lvl }
skl.aba.onLevel = function (this: any) { you.cmaff[1] += Math.ceil(this.lvl / 3 + 1) }
skl.aba.onGive = function (this: any, x: any) { if (!you.ki['a']) you.ki['a'] = x; else you.ki['a'] += x }
...
skl.abe.use = function (this: any, x: any, y: any) { return this.lvl }
skl.abe.onLevel = function (this: any) { you.cmaff[2] += Math.ceil(this.lvl / 3 + 1) }
skl.abe.onGive = function (this: any, x: any) { if (!you.ki['e']) you.ki['e'] = x; else you.ki['e'] += x }
...
skl.abl.use = function (this: any, x: any, y: any) { return this.lvl }
skl.abl.onLevel = function (this: any) { you.cmaff[5] += Math.ceil(this.lvl / 3 + 1) }
skl.abl.onGive = function (this: any, x: any) { if (!you.ki['l']) you.ki['l'] = x; else you.ki['l'] += x }
...
skl.abd.use = function (this: any, x: any, y: any) { return this.lvl }
skl.abd.onLevel = function (this: any) { you.cmaff[6] += Math.ceil(this.lvl / 3 + 1) }
skl.abd.onGive = function (this: any, x: any) { if (!you.ki['d']) you.ki['d'] = x; else you.ki['d'] += x }

// @ts-ignore: constructor function
skl.hvt = new Skill({ id: 141, type: 8, name: 'Foraging', desc: 'Ability to harvest gifts of Nature' });
skl.hvt.use = function (this: any, x: any, y: any) { return this.lvl }

// @ts-ignore: constructor function
skl.glg = new Skill({ id: 142, type: 8, name: 'Geology', desc: 'Knowledge and ability to identify precious minerals' });
skl.glg.use = function (this: any, x: any, y: any) { return this.lvl }

// @ts-ignore: constructor function
skl.mng = new Skill({ id: 143, type: 8, name: 'Mining', desc: 'Ability to extract materials from stones and mountains' });
skl.mng.use = function (this: any, x: any, y: any) { return this.lvl }

// @ts-ignore: constructor function
skl.mntnc = new Skill({ id: 144, type: 9, name: 'Maintanence', desc: 'Ability to repair damaged equipment' });
skl.mntnc.use = function (this: any, x: any, y: any) { return this.lvl }

// @ts-ignore: constructor function
skl.rccln = new Skill({ id: 145, type: 9, name: 'Temperance', desc: 'Ability to resist temptation of worldly possessions' });
skl.rccln.use = function (this: any, x: any, y: any) { return this.lvl }
...
skl.bledr.use = function (this: any, x: any, y: any) { return this.lvl * .01 }
...
skl.twoh.use = function (this: any, x: any, y: any) { giveSkExp(this, 1); return you.str * (this.lvl * .0125) }
...
skl.trad.use = function (this: any, x: any, y: any) { return this.lvl * .005 }
skl.trad.onLevel = function (this: any) { recshop() }

// @ts-ignore: constructor function
skl.swm = new Skill({ id: 149, type: 3, name: 'Swimming', desc: 'Ability to dive and traverse waters' });
skl.swm.use = function (this: any, x: any, y: any) { return this.lvl }
...
skl.dssmb.use = function (this: any, x: any, y: any) { return this.lvl }
...
skl.hst.use = function (this: any, x: any, y: any) { return this.lvl }
